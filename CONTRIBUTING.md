# Contributing to phaser3-doms-plugin
...
```
$ git clone https://github.com/koreezgames/phaser3-doms-plugin.git
```
...
-   Feel free to ask for help from other members of the Koreez team via the
    [github issues](https://github.com/koreezgames/phaser3-doms-plugin/issues).
